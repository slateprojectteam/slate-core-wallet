...
This means one can have an always-on slcd instance running, and another local slcd/slc-qt instance which connects to this node and receives blocks from it.
