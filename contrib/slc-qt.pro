...
RESOURCES += src/qt/slc.qrc src/qt/slc_locale.qrc

TRANSLATIONS += src/qt/locale/slc_bg.ts \
                src/qt/locale/slc_de.ts \
                src/qt/locale/slc_en.ts \
                src/qt/locale/slc_es.ts \
                src/qt/locale/slc_fi.ts \
                src/qt/locale/slc_fr.ts \
                src/qt/locale/slc_it.ts \
                src/qt/locale/slc_ja.ts \
                src/qt/locale/slc_pl.ts \
                src/qt/locale/slc_pt.ts \
                src/qt/locale/slc_ru.ts \
                src/qt/locale/slc_sk.ts \
                src/qt/locale/slc_sv.ts \
                src/qt/locale/slc_vi.ts \
                src/qt/locale/slc_zh_CN.ts \
                src/qt/locale/slc_zh_TW.ts
