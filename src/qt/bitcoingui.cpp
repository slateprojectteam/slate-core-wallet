                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SLC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SLC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and slc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SLC Core"), this);
    aboutAction->setStatusTip(tr("Show information about SLC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SLC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SLC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SLC addresses"));
    ...
    openAction->setStatusTip(tr("Open a SLC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SLC Core help message to get a list with possible SLC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SLC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SLC network", "", count));
}
...
{
    QString strTitle = tr("SLC Core"); // default title
