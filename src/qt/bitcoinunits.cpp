...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SLC);
    unitlist.append(mSLC);
    unitlist.append(uSLC);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SLC:
            return QString("SLC");
        case mSLC:
            return QString("Milli-SLC (1 / 1" THIN_SP_UTF8 "000)");
        case uSLC:
            return QString("Micro-SLC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
