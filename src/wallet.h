...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT5000IFMN = 3,
    ONLY_NONDENOMINATED_NOT5000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 SLC at the same time
    ONLY_6000 = 5                        // find masternode outputs including locked ones (use with caution)
};
