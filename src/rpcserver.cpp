...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SLC features */
        {"slc", "masternode", &masternode, true, true, false},
        {"slc", "listmasternodes", &listmasternodes, true, true, false},
        {"slc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"slc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"slc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"slc", "masternodedebug", &masternodedebug, true, true, false},
        {"slc", "startmasternode", &startmasternode, true, true, false},
        {"slc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"slc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"slc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"slc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"slc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"slc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"slc", "mnbudget", &mnbudget, true, true, false},
        {"slc", "preparebudget", &preparebudget, true, true, false},
        {"slc", "submitbudget", &submitbudget, true, true, false},
        {"slc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"slc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"slc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"slc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"slc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"slc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"slc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"slc", "checkbudgets", &checkbudgets, true, true, false},
        {"slc", "mnsync", &mnsync, true, true, false},
        {"slc", "spork", &spork, true, true, false},
        {"slc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"slc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use slcd, or the -server option to slc-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"SLC Alert\" admin@foo.com\n"),
...
{
    return "> slc-cli " + methodname + " " + args + "\n";
}
