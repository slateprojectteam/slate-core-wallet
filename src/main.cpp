...
#if defined(NDEBUG)
#error "SLC cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    int halvings = (nHeight - 380000) / Params().SubsidyHalvingInterval(); 
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 1 * COIN;
    } else if (101 <= nHeight && nHeight <= 500) {
        nSubsidy = 3 * COIN;
    } else if (501 <= nHeight && nHeight <= 800) {
        nSubsidy = 5 * COIN;
    } else if (801 <= nHeight && nHeight <= 2000) {
        nSubsidy = 7 * COIN;
    } else if (2001 <= nHeight && nHeight <= 50000) {
        nSubsidy = 24 * COIN;
    } else if (50001 <= nHeight && 1400000 <= nHeight) {
        nSubsidy = 24 * COIN;
        if(380000 <= nHeight) {
            nSubsidy >>= halvings;
        }
