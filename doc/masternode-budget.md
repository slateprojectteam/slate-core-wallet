...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<slc_address\> \<monthly_payment_slc\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ SLC, _12_ times over the course of a year totaling _24000_ SLC.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<slc_address\> \<monthly_payment_slc\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` SLC.
