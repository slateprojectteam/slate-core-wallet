...
In order to support loading of multiple wallets in slc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is slc.cpp.
...
Changes to slc.cpp
----------------------
slc.cpp is the entry point into slc-qt, and as such, will require some minor modifications to provide hooks for
